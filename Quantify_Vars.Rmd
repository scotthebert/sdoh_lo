...
screen <- glm(sdoh_within_last_12_months ~ location_name + age + current_gender + relevel(as.factor(race), ref = "White") + eth2 + lang2 + ins2 + zip_cond, family = "binomial", data = SDOH_DS)
summary(screen)
```
